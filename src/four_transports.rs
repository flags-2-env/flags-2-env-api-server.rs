#![forbid(unsafe_code)]
//! Serving the four avenues from `flags-2-env-api-server`.
//!
...
//! |---|------|---------------------|
//! | 1 | `direct_read` | none: the web server reads Postgres itself through `flags-2-env-lib-core` |
...
///
/// Bind `FLAGS_2_ENV_API_MTLS_ADDR` and pass the listener. One task per
...
/// Open the JetStream context for avenue 4 from `FLAGS_2_ENV_NATS_URL`.
///
/// # Errors
